...
author: John Doe
author_avatar: /sample-logo.png
author_description: "Fullstack Developer"
...
#body
Fullstack Developer with a passion for building scalable and performant web applications. Love tinkering with Arduino and a recent curiosity for AI and machine learning

#actions
:u-button{icon="mdi:youtube" to="https://www.youtube.com/@benkissi2194" title="Youtube" variant="subtle" color="neutral" target="_blank"}
:u-button{icon="mdi:linkedin" to="https://www.linkedin.com/in/benkissi" title="LinkedIn" variant="subtle" color="neutral" target="_blank"}
:u-button{icon="mdi:github" to="https://github.com/benkissi" title="Github" variant="subtle" color="neutral" target="_blank"}
::